...
def run_translate():
    ...
    input_text = detect_language_response.get('text')
    ...
    return render_template('run_translate.html', input_text=input_text, language=language, translated_text_french=translated_text_french)
